...
#include "parsing_report_alalrm.h"
#include "queue.h"
...

					{
						...
						if(buf[10] == 0x80)
						{
							...
							else
							{
								...
								st->setSQL(sql);
				 				rs = st->executeQuery();
								if(rs->next() != 0)              //��ѯ���ϱ����Ƿ��д��ڸñ���  �оͲ�����  û�оͲ�����ϱ�
								{
						...
						else if(buf[10] == 0x81)
						{
							...
							else
							{
								...
								st->setSQL(sql);
				 				rs = st->executeQuery();
								if(rs->next() != 0)              //��ѯʵʱ���ϱ����Ƿ��д��ڸñ���  �оͲ�����  û�оͲ�����ϱ�
								{
									printf("signal_id =%d ,yi cun zai green_fault\n",buf[7] * 256 + buf[8]);
									continue;
								}
						...
						else if(buf[10] == 0x82)
						{
							...
							for(i = 0 ; i < 32; i++)
							{
								...
								if((fault_data & temp) != 0)
								{
									...
									//signal_info_data[signal_num].lamp_failures[i][0]= 1;// ��Ӧ��λ�ƹ��ϱ�־
								}
							}
